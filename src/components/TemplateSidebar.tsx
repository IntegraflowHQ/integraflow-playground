            ...
            <>
              <ul className="px-2 space-y-2">
                ...
                <li>
                  ...
                  >
                    <Collapsible.Trigger className="flex items-center space-x-6 border-[#6841C6] border-2 p-1 mb-1 rounded-md">
                      <span>Placement</span>
                      <span>
                        {openPlacement ? (
                          <ChevronUp size={19} />
                    ...
                    <Collapsible.Content className="shadow-sm rounded bg-[#eee] border-2">
